...
namespace SatoshisCrypto.Controllers
{
  public class HomeController : Controller
  {
    ...
    public IActionResult Index()
    {
      ...
      _db.BtcComments.AddRange(get16hrComments);
      _db.SaveChanges();
      ...
      _db.EthComments.AddRange(eth16hrComments);
      _db.SaveChanges();
      ...
      _db.AdaComments.AddRange(ada16hrComments);
      _db.SaveChanges();
      ...
      _db.LinkComments.AddRange(link16hrComments);
      _db.SaveChanges();
      ...
      _db.DogeComments.AddRange(doge16hrComments);
      _db.SaveChanges();
      ...
      // Console.WriteLine(btcCountDistinct);
      // Console.WriteLine(ethCountDistinct);
      // Console.WriteLine(adaCountDistinct);
      // Console.WriteLine(linkCountDistinct);
      // Console.WriteLine(dogeCountDistinct);
      ...
      sortedCommentList.ToList();

      ViewBag.finalList = sortedCommentList;

      // Console.WriteLine(sortedCommentList);
